...
class Producto {
 ...
 validarItemBorrar = () =>{
    $(`.itemBorrar > button`).click( function () {
       $(`#divProd${$(this).attr("producto")}`).fadeOut(500);
       setTimeout(function () { carrito.borrarProducto($(this).attr("producto"));
       carritoStorage = localStorage.setItem("carritoLocal", JSON.stringify(carrito));
       actualizarItems();
       mostrarCarrito(); }, 500);
 ...
 const mostrarCarrito = () =>{
   ...
   carrito.productos.forEach( producto => {
      $(`#productosCarrito`).append(`<div id="divProd${producto.id}" class="itemCarrito justify-content-center align-items-center">
      ...
      <div class="itemCarrito__info justify-content-center align-items-center">
        ...
        <div class="itemCarrito__cantPrec justify-content-center align-items-center">
          <div class="itemCantidad justify-content-center">
            <button class="itemBtn menos" producto="${producto.id}"><i class="fas fa-minus"></i></button><span class="cant${producto.id}">${producto.cantidad}</span><button class="itemBtn mas" producto="${producto.id}"><i class="fas fa-plus"></i></button>
          </div>
          <div class="itemPrecio justify-content-center">
            <span producto="precio${producto.id}">$${producto.precioTotal}</span>
          </div>
